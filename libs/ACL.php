...
class ACL
{
	...
	public static $role_pages = array(
			'administrator' =>
						array(
							'data_prodi' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'data_sepeda' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'penyewaan' => array('list','view','add','edit', 'editfield','delete','import_data','laporan','page_pending','page_ditolak','page_diterima'),
							'users' => array('list','view','add','edit', 'editfield','delete','import_data','userregister','accountedit','accountview','list_user','akun_aktif','akun_pending','akun_blocked'),
							'denda_berlaku' => array('list','view','add','edit', 'editfield','delete'),
							'pemgembalian' => array('list','view','add','edit', 'editfield','delete')
						),
		
			'user' =>
						array(
							'data_sepeda' => array('view'),
							'penyewaan' => array('view','halaman_user','halaman_user_add','page_pending','page_ditolak','page_diterima'),
							'users' => array('view','list_user','akun_aktif','akun_pending','akun_blocked'),
							'pemgembalian' => array('user_penegembalian')
						)
		);
