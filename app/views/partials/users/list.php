                                                    ...
                                                    <table class="table  table-striped table-sm text-center">
                                                        <thead class="table-header bg-light">
                                                            <tr>
                                                                ...
                                                                <?php } ?>
                                                                <th class="td-sno">#</th>
                                                                <th  class="td-nama_lengap"> Nama Lengkap</th>
                                                                <th  class="td-nim"> NIM</th>
                                                                <th  class="td-prodi"> Program Studi</th>
                                                                <th  class="td-kontak"> Kontak</th>
                                                                <th  class="td-users_name"> Users Name</th>
                                                                <th  class="td-email"> Email</th>
                                                                <th  class="td-image"> Pas Foto</th>
                                                                <th  class="td-ktm"> KTM</th>
                                                        ...
                                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th class=" td-checkbox">
                                                                    <label class="custom-control custom-checkbox custom-control-inline">
                                                                        <input class="optioncheck custom-control-input" name="optioncheck[]" value="<?php echo $data['nim'] ?>" type="checkbox" />
                                                                            <span class="custom-control-label"></span>
                                                                        </label>
                                                                    </th>
                                                                    <?php } ?>
                                                                    <th class="td-sno"><?php echo $counter; ?></th>
                                                                    <td class="td-nama_lengap"> <?php echo $data['nama_lengap']; ?></td>
                                                                    <td class="td-nim"> <?php echo $data['nim']; ?></td>
                                                                    <td class="td-prodi"> <?php echo $data['prodi']; ?></td>
                                                                    <td class="td-kontak"> <?php echo $data['kontak']; ?></td>
                                                                    <td class="td-users_name"> <?php echo $data['users_name']; ?></td>
                                                                    <td class="td-email"><a href="<?php print_link("mailto:$data[email]") ?>"><?php echo $data['email']; ?></a></td>
                                                                    <td class="td-image"><?php Html :: page_img($data['image'],50,50,1); ?></td>
                                                                    <td class="td-ktm"><?php Html :: page_img($data['ktm'],50,50,1); ?></td>
                                                                    ...
                                                                    <td class="page-list-action td-btn">
                                                                        <div class="dropdown" >
                                                                            ...
                                                                            <ul class="dropdown-menu">
                                                                                <?php if($can_view){ ?>
                                                                                <a class="dropdown-item page-modal" href="<?php print_link("users/view/$rec_id"); ?>">
                                                                                    <i class="fa fa-eye"></i> View 
                                                                                </a>
                                                                                <?php } ?>
                                                                                <?php if($can_edit){ ?>
                                                                                <a class="dropdown-item page-modal" href="<?php print_link("users/edit/$rec_id"); ?>">
                                                    ...
                                                    <div class=" border-top mt-2">
                                                        <div class="row justify-content-center">    
                                                            ...
                                                            <div class="tab-pane  fade" id="TabPage-1-Page2" role="tabpanel">
                                                                <div class=" ">
                                                                    <?php  
                                                                    $this->render_page("users/list_user/users.level/User?limit_count=25" , array( 'show_header' => false,'show_footer' => false )); 
                                                                    ?>
                                                                </div>
                                                            </div>
                                                            <div class="tab-pane  fade" id="TabPage-1-Page3" role="tabpanel">
                                                                <div class=" ">
                                                                    <?php  
                                                                    $this->render_page("users/list_user/users.account_status/Pending?limit_count=25" , array( 'show_header' => false,'show_footer' => false )); 
                                                                    ?>
                                                                </div>
                                                            </div>
                                                            <div class="tab-pane  fade" id="TabPage-1-Page4" role="tabpanel">
                                                                <div class=" ">
                                                                    <?php  
                                                                    $this->render_page("users/list_user/users.account_status/Active?limit_count=25" , array( 'show_header' => false,'show_footer' => false )); 
                                                                    ?>
                                                                </div>
                                                            </div>
                                                            <div class="tab-pane  fade" id="TabPage-1-Page5" role="tabpanel">
                                                                <div class=" ">
                                                                    <?php  
                                                                    $this->render_page("users/list_user/users.account_status/Blocked?limit_count=25" , array( 'show_header' => false,'show_footer' => false )); 
                                                                    ?>
                                                                </div>
                                                            </div>
                                                        </div>
