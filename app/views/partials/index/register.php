                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    <input id="ctrl-nim"  value="<?php  echo $this->set_field_value('nim',""); ?>" type="number" placeholder="Nomor induk Mhs" step="1"  required="" name="nim"  class="form-control " />
                                                        <div class="input-group-append">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <label class="control-label" for="prodi">Program Studi <span class="text-danger">*</span></label>
                                                </div>
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <label class="control-label" for="kontak">Kontak Aktif <span class="text-danger">*</span></label>
                                                </div>
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        <input id="ctrl-kontak"  value="<?php  echo $this->set_field_value('kontak',""); ?>" type="number" placeholder="Enter Kontak Aktif" step="1"  required="" name="kontak"  class="form-control " />
                                                            <div class="input-group-append">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="input-group">
                                                                <input id="ctrl-users_name"  value="<?php  echo $this->set_field_value('users_name',""); ?>" type="text" placeholder="Enter Users Name"  readonly required="" name="users_name"  data-url="api/json/users_users_name_value_exist/" data-loading-msg="Checking availability ..." data-available-msg="Available" data-unavailable-msg="Not available" class="form-control  ctrl-check-duplicate" />
                                                                    <div class="check-status"></div> 
                                                                    <div class="input-group-append">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        ...
                                                                        <small class="form-text"><p class="text-danger">Upload Pas Foto * </p></small>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group ">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            ...
                                                                            <small class="form-text"><p class="text-danger">upload KTM Aktif *</p></small>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
