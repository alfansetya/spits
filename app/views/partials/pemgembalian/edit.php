...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Pemgembalian</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("pemgembalian/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <select required=""  id="ctrl-id_sewa" data-load-select-options="id_sepeda" name="id_sewa"  placeholder="Masukkan Kode Booking"    class="selectize" >
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <select required=""  id="ctrl-nim" name="nim"  placeholder="Select a value ..."    class="custom-select" >
                                                    <option value="">Select a value ...</option>
                                                    <?php
                                                    $rec = $data['nim'];
                                                    $nim_options = $comp_model -> pemgembalian_nim_option_list();
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <select required=""  id="ctrl-id_sepeda" data-load-path="<?php print_link('api/json/pemgembalian_id_sepeda_option_list') ?>" name="id_sepeda"  placeholder="Select a value ..."    class="custom-select" >
                                                    <?php
                                                    $rec = $data['id_sepeda'];
                                                    $id_sepeda_options = $comp_model -> pemgembalian_id_sepeda_option_list($data['id_sewa']);
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <select required=""  id="ctrl-status_pengembalian" name="status_pengembalian"  placeholder="Select a value ..."    class="custom-select" >
                                                    <option value="">Select a value ...</option>
                                                    <?php
                                                    $rec = $data['status_pengembalian'];
                                                    $status_pengembalian_options = $comp_model -> pemgembalian_status_pengembalian_option_list();
