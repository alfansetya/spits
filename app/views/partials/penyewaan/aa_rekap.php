                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="penyewaan-aa_rekap-records">
                                    ...
                                    <table class="table  table-striped table-sm text-center">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-pemgembalian_id_pengembalian"> Pemgembalian Id Pengembalian</th>
                                                <th  class="td-pemgembalian_tgl_pengembalian"> Pemgembalian Tgl Pengembalian</th>
                                                <th  class="td-pemgembalian_keterangan"> Pemgembalian Keterangan</th>
                                                <th  class="td-pemgembalian_status_pengembalian"> Pemgembalian Status Pengembalian</th>
                                                <th  class="td-pemgembalian_id_sewa"> Pemgembalian Id Sewa</th>
                                                <th  class="td-pemgembalian_id_sepeda"> Pemgembalian Id Sepeda</th>
                                                <th  class="td-pemgembalian_nim"> Pemgembalian Nim</th>
                                                <th class="td-btn"></th>
                                            </tr>
                                        </thead>
                                        <?php
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <th class=" td-checkbox">
                                                    ...
                                                    ?></span></td>
                                                    <td class="td-pemgembalian_id_pengembalian"> <?php echo $data['pemgembalian_id_pengembalian']; ?></td>
                                                    ...
                                                    <td class="td-pemgembalian_status_pengembalian"> <?php echo $data['pemgembalian_status_pengembalian']; ?></td>
                                                    <td class="td-pemgembalian_id_sewa"> <?php echo $data['pemgembalian_id_sewa']; ?></td>
                                                    <td class="td-pemgembalian_id_sepeda"> <?php echo $data['pemgembalian_id_sepeda']; ?></td>
                                                    <td class="td-pemgembalian_nim"> <?php echo $data['pemgembalian_nim']; ?></td>
