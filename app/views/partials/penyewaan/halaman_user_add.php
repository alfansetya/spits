            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="penyewaan-halaman_user_add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("penyewaan/halaman_user_add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        <input id="ctrl-tgl_mulai" class="form-control datepicker  datepicker"  required="" value="<?php  echo $this->set_field_value('tgl_mulai',date_now()); ?>" type="datetime" name="tgl_mulai" placeholder="Enter Tanggal Peminjaman" data-enable-time="false" data-min-date="" data-max-date="" data-date-format="Y-m-d" data-alt-format="F j, Y" data-inline="false" data-no-calendar="false" data-mode="single" />
                                                            <div class="input-group-append">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="input-group">
                                                            <input id="ctrl-tgl_akhir" class="form-control datepicker  datepicker"  required="" value="<?php  echo $this->set_field_value('tgl_akhir',date_now()); ?>" type="datetime" name="tgl_akhir" placeholder="Enter Tanggal Pengembalian" data-enable-time="false" data-min-date="" data-max-date="" data-date-format="Y-m-d" data-alt-format="F j, Y" data-inline="false" data-no-calendar="false" data-mode="single" />
                                                                <div class="input-group-append">
                                                                    <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                                                </div>
                                                            </div>
