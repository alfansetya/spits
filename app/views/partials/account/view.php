                    ...
                    <div  class="card animated fadeIn page-content">
                        ...
                        <div class="bg-primary m-2 mb-4">
                            <div class="profile">
                                ...
                                <h1 class="title mt-4"><?php echo $data['users_name']; ?></h1>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">
                                            ...
                                            <table class="table table-hover table-borderless table-striped">
                                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                                    ...
                                                    <tr  class="td-kontak">
                                                        ...
                                                        <td class="value">
                                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['kontak']; ?>" 
                                                                data-pk="<?php echo $data['nim'] ?>" 
                                                                data-url="<?php print_link("users/editfield/" . urlencode($data['id_users'])); ?>" 
                                                                data-name="kontak" 
                                                    ...
                                                    <tr  class="td-prodi">
                                                        ...
                                                        <td class="value">
                                                            <span <?php if($can_edit){ ?> data-source='<?php print_link('api/json/account_prodi_option_list'); ?>' 
