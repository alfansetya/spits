...
class IndexController extends BaseController{
	...
	private function login_user($username , $password_text, $rememberme = false){
		...
		$db->where("users_name", $username)->orWhere("email", $username);
	...
	function register($formdata = null){
		if($formdata){
			...
			$db = $this->GetModel();
			$tablename = $this->tablename;
			$fields = $this->fields = array("nama_lengap","nim","prodi","kontak","email","users_name","password","image","ktm","level","account_status"); //registration fields
